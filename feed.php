...
include('header.php'); ?>
<script src="./lib/js/tinysort.js"></script>
<?php
...
$query = 'SELECT Titre, Post.Bio,Post.Id ,CreateurId,Nom,Date,
       ...
       SUM(CASE WHEN Likes.UserId='.$_SESSION['IdUser'].' and Likes.Isliked=1 THEN 1 ELSE 0  END)as UserLiked,
    SUM(CASE WHEN Likes.UserId='.$_SESSION['IdUser'].' and Likes.IsDisliked=1 THEN 1 ELSE 0 END)as UserDisliked
...
<head>
    ...
    <script src="./js/showAddcom.js"></script>
</head>
...
<main class="main">
    ...
    foreach ($row as $item):?>
    <article class="unpost" data-nombredislike="<?php echo $item["nbr_dislikes"];?>" data-nombrelike="<?php echo $item["nbr_likes"];?>" data-date="<?php echo $item["Date"];?>" data-nombrecomment="">

        <main class="lightblue-background post" id='<?php echo "post_num".$num_post ; $num_post ++;?>'>
            <header>

                <div class="profil-picture">
                    <a href="./profil.php?UserId=<?php echo $item["CreateurId"] ; ?>">
                    <img src="./ImageView.php?ImageId=<?php echo $item["CreateurId"] ; ?>&req=User">
                    </a>
                </div>
                <div>
                    <a class="color-darkblue" href="./profil.php?UserId=<?php echo $item["CreateurId"] ; ?>">
            ...
            <footer>
                ...
                <div class="align-center big-like">
                    ...
                    <div class="div-sup-dislike">
                        <div class="<?php if(boolval($item["UserDisliked"])){echo "liked";}else{echo "like";};?> disliked" data-postid="<?php echo $item["Id"];?>"></div>
                    </div>
                </div>
            </footer>
        ...
        <aside class="lightblue-background">
            <div class="aside" data-com = "<?php echo $item["Id"]; ?>">
                ...
                <div class="com">
                    <a href="./profil.php?UserId=<?php echo $comment["UserId"] ; ?>">
            ...
            <div class="align-center ajout-com">
                <div class="button-show-com">
                    <button id="<?php echo $num_button_post; ?>" class="lightblue-background color-lightblue" onclick="showAddCom(<?php echo $num_button_post ; $num_button_post ++;?>)">
                    <img src="./img/Boutonpost.png" alt="bouton pour ajouter des commentaire">
                    </button>
                </div>
                <form class="form-ajout-com align-center hidden">
